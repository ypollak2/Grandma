...
def _render_default(verdict: Verdict) -> None:
    ...
    console.print(Panel(body, title="[bold magenta]👵 grandma[/bold magenta]", border_style="magenta"))
...
def _render_deep(verdict: Verdict) -> None:
    ...
    console.print(Panel(table, title="[bold magenta]👵 grandma[/bold magenta]", border_style="magenta"))
